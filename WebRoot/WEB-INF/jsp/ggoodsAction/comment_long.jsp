...
<hr>
		<s:form
		action="ggoods_longcomment?goodsId=%{goodsId}">
		...
		<div class="media">
		  ...
		  <div class="media-body">
		    ...
		    <a class="btn btn-default" href="gcommentlong_del.action?commentId=<s:property value="#l1.commentId" />&goodsId=<s:property value="#l1.TGGoods.goodsId" />" role="button">删除</a>
		  </div>
		</div>
		</s:iterator>
